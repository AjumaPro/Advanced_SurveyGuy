...
-- Run this after COMPREHENSIVE_SYSTEM_VERIFICATION.sql
...
BEGIN
    ...
    SELECT * FROM (VALUES
        ('Free', 'Basic survey creation and management', 0.00, 'monthly', 3, 100, 10, '{"analytics": false, "export": false, "custom_branding": false, "api_access": false}'::jsonb),
        ('Pro', 'Advanced features for professional users', 19.99, 'monthly', 50, 5000, 100, '{"analytics": true, "export": true, "custom_branding": true, "api_access": true}'::jsonb),
        ('Enterprise', 'Full-featured solution for large organizations', 99.99, 'monthly', 0, 0, 0, '{"analytics": true, "export": true, "custom_branding": true, "api_access": true, "sso": true, "priority_support": true}'::jsonb)
