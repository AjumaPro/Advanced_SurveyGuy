-- =============================================
-- TEAM COLLABORATION SYSTEM - FIXED VERSION
-- Fixed parameter order issue in functions
-- =============================================
...
-- =============================================
-- HELPER FUNCTIONS (FIXED PARAMETER ORDER)
-- =============================================
...
-- Function to add team member (FIXED: all parameters after default have defaults)
...
-- Function to create team invitation (FIXED: moved required parameter before default)
