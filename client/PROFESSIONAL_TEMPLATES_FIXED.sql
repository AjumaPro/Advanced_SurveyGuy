-- =============================================
-- PROFESSIONAL SURVEY & EVENT TEMPLATES (FIXED)
...
BEGIN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'is_template' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN is_template BOOLEAN DEFAULT false;
        RAISE NOTICE 'Added is_template column to events table';
    END IF;
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'category' AND table_schema = 'public') THEN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'capacity' AND table_schema = 'public') THEN
        ...
        RAISE NOTICE 'Added capacity column to events table';
    END IF;
    
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'price' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN price DECIMAL(10,2) DEFAULT 0.00;
        RAISE NOTICE 'Added price column to events table';
    END IF;
    
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'currency' AND table_schema = 'public') THEN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'venue' AND table_schema = 'public') THEN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'starts_at' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN starts_at TIMESTAMPTZ;
        RAISE NOTICE 'Added starts_at column to events table';
    END IF;
    
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'ends_at' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN ends_at TIMESTAMPTZ;
        RAISE NOTICE 'Added ends_at column to events table';
    END IF;
    
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'registration_fields' AND table_schema = 'public') THEN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'event_settings' AND table_schema = 'public') THEN
    ...
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'features' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN features JSONB DEFAULT '[]'::jsonb;
        RAISE NOTICE 'Added features column to events table';
    END IF;
    
    IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'events' AND column_name = 'target_audience' AND table_schema = 'public') THEN
        ALTER TABLE public.events ADD COLUMN target_audience TEXT;
        RAISE NOTICE 'Added target_audience column to events table';
    END IF;
    
    RAISE NOTICE 'Events table structure verified and updated';
END $$;
...
-- =============================================
-- STEP 3: EVENT TEMPLATES - PROFESSIONAL EVENT MANAGEMENT
-- =============================================
